...
public class Slice : MonoBehaviour
{
    ...
    public Transform[] ComputeSlice(Vector3 sliceNormalWorld, Vector3 sliceOriginWorld)
    {
        var mesh = this.GetComponent<MeshFilter>().sharedMesh;
        Transform[] fragments = null;
        ...
        if (mesh != null)
        {
            ...
            fragments = fragmentRoot.GetComponentsInChildren<Transform>();
