...
public class SlicerOld {
    ...
    public static GameObject[] Slice(Plane plane, GameObject objectToCut) {
        ...
        if(sliceable == null) {
            throw new MissingComponentException("Cannot slice non sliceable object, add the sliceable script to the object or inherit from sliceable to support slicing.");
        }

        // Create left and right slice of hollow object
        SlicesMetadata slicesMeta = new SlicesMetadata(plane, mesh, sliceable.IsSolid, sliceable.ReverseWindTriangles, sliceable.ShareVertices, sliceable.SmoothVertices);
